...
//const {data} = useFetch(`https://api.themoviedb.org/3/movie/${id}?api_key=f5773e1237f778ecf6dcf7bdb9e5c860&language=en-US`) 

//  console.log(data)
//  const carta = Object.entries(data).map(img => {
//     return {
//         id: img.id,
//         title: img.title,
...
const getSearch = async() => {
  ...
  const URL = `https://api.themoviedb.org/3/movie/${id}?api_key=f5773e1237f778ecf6dcf7bdb9e5c860&language=en-US`
  ...
  <div className="container10">
    ...
    <div className="hero" style={{
      ...
      <div className="details10">
        ...
        <div className="title10"> {carta.title} </div>   
    ...
    <div className="description">
      ...
      <div className="column10">
        ...
        <p className="release_date"><b>Release Date:</b><br/> {carta.release_date} </p>
